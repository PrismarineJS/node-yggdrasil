...
Server.joinP = util.promisify(Server.join)

Server.hasJoinedP = util.promisify(Server.hasJoined)

Server.joinC = util.callbackify(Server.joinC)

Server.hasJoinedC = util.callbackify(Server.hasJoinedP)
